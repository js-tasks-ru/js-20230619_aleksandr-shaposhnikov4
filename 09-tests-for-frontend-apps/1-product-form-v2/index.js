...
export default class ProductForm {
  ...
  renderImageElements() {
    ...
    this.imageListElement = new SortableList({ items: images });
    this.subElements.imageListContainer.append(this.imageListElement.element);
  }
  ...
  getImages() {
    if (Array.isArray(this.data.productData[0].images)) {
      return this.data.productData[0].images.map(item => this.createListItemTeamplate(item));
    }
  }
  ...
  createListItemTeamplate(item) {
    ...
    element.innerHTML = `<input type="hidden" name="url" value="${item.url}">
  ...
  getTemplate() {
    ...
    <form data-element="productForm" class="form-grid">
        ...
        <div class="form-group form-group__wide" data-element="sortable-list-container">
          ...
          <div id="images" data-element="imageListContainer"></div>
